...
是国内的魔幻网络和运营商搞的鬼。运营商将`github.com`的地址解析到了本地`127.0.0.1`（DNS污染），因此无法访问。  

尝试修改您电脑的DNS服务器地址以解决此问题：
- 将ipv4改为`8.8.8.8`
- 将ipv6改为`2001:4860:4860::8888`

再在命令行中通过`nslookup github.com`来查看解析是否正确：

![](https://cdn.jsdelivr.net/gh/katorly/Gallery001/blog/20220606084241.png)  
